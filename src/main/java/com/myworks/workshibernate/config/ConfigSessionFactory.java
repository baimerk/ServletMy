package com.myworks.workshibernate.config;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/kyronservice?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC");
